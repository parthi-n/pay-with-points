	...
	return (
		<div className="font-sans  mx-auto bg-white py-4">
			...
			<div className="grid md:grid-cols-3 gap-8 mt-16  ">
				<div className="md:col-span-2 space-y-4 bg-gray-100 rounded-2xl p-8">
					{orderedList.length > 0 ? (
						orderedList.map((order) => (
							<div key={order.id}>
								...
								<div className="ml-auto my-6 flex flex-row justify-between items-center border-t border-black/10 py-4">
