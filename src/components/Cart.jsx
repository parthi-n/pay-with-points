...
export default function cart({ cartItems, handleAddQuantity, handleRemoveQuantity }) {
						...
						<div key={item.id} class="grid grid-cols-3 items-start gap-4">
							...
							<div class="ml-auto">
								...
								<div class="mt-6 flex items-center px-3 py-1.5 border border-gray-300 text-gray-800 text-xs outline-none bg-transparent rounded-md">
									...
									<button type="button" onClick={() => handleRemoveQuantity(item)}>
									...
									<button type="button" onClick={() => handleAddQuantity(item)}>
