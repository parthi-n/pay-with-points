...
export default function CartItem({ item, handleAddQuantity, handleRemoveQuantity, handleRemoveItem }) {
	...
	return (
		<div key={id} className="grid grid-cols-3 items-start gap-4">
			<div className="col-span-2 flex items-start gap-4">
				<div className="w-28 h-28 max-sm:w-24 max-sm:h-24 shrink-0 border-gray-100 border-2 p-2 rounded-md">
				...
				<div className="flex flex-col">
					<Link to={`/sneakers/${slug}`}>
						...
						<p className="text-xs font-semibold text-gray-500 mt-0.5">Size: {size}</p>
					</Link>
